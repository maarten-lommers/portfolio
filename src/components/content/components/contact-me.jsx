...
function ContactMe() {
    ...
    return (
        <section ref={ref} className="py-20 mb-32 mt-6 text-center px-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center min-w-sm">
                <Button variant="surface" href=""><FaLinkedin className="mb-0.5" />LinkedIn</Button>
                <Button href=""><FaEnvelope className="mb-0.5" />Maarten.lommers76@gmail.com</Button>
